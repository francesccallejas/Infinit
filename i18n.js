...
(function () {
  ...
  var DICT = {
    en: {
      ...
      'st.big': 'All led hands-on by <span class="chip"><img src="project/assets/imagery/francesc.webp" alt="Cesc Callejas"></span> <span class="snm">Cesc Callejas</span> — two decades on both sides of the table: building brands, and running the operations that depend on them. No layers. You work with him.',
    ...
    es: {
      ...
      'st.big': 'Todo liderado en persona por <span class="chip"><img src="project/assets/imagery/francesc.webp" alt="Cesc Callejas"></span> <span class="snm">Cesc Callejas</span> — dos décadas a ambos lados de la mesa: construyendo marcas y dirigiendo las operaciones que dependen de ellas. Sin capas. Trabajas con él.',
    ...
    ca: {
      ...
      'st.big': 'Tot liderat en persona per <span class="chip"><img src="project/assets/imagery/francesc.webp" alt="Cesc Callejas"></span> <span class="snm">Cesc Callejas</span> — dues dècades a banda i banda de la taula: construint marques i dirigint les operacions que en depenen. Sense capes. Treballes amb ell.',
